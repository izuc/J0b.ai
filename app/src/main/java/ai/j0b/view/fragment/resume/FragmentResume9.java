...
import ai.j0b.databinding.FragmentResume9Binding;
...
public class FragmentResume9 extends Fragment {
    private FragmentResume9Binding binding;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentResume9Binding.inflate(inflater, container, false);
        setupUI();
