...
import ai.j0b.databinding.FragmentResume1Binding;
...
public class FragmentResume1 extends Fragment {
    private FragmentResume1Binding binding;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentResume1Binding.inflate(inflater, container, false);
        setupUI();
