...
import ai.j0b.databinding.FragmentResume4Binding;
...
public class FragmentResume4 extends Fragment {
    private FragmentResume4Binding binding;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentResume4Binding.inflate(inflater, container, false);
        setupUI();
