...
import ai.j0b.databinding.FragmentResume7Binding;
...
public class FragmentResume7 extends Fragment {
    private FragmentResume7Binding binding;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentResume7Binding.inflate(inflater, container, false);
        setupUI();
