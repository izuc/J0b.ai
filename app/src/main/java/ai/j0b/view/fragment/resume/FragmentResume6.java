...
import ai.j0b.databinding.FragmentResume6Binding;
...
public class FragmentResume6 extends Fragment {
    private FragmentResume6Binding binding;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentResume6Binding.inflate(inflater, container, false);
        setupUI();
