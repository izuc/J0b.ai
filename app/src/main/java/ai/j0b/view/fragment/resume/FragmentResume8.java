...
import ai.j0b.databinding.FragmentResume8Binding;
...
public class FragmentResume8 extends Fragment {
    private FragmentResume8Binding binding;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentResume8Binding.inflate(inflater, container, false);
        setupUI();
