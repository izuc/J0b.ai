...
import ai.j0b.databinding.FragmentResume2Binding;
...
public class FragmentResume2 extends Fragment {
    private FragmentResume2Binding binding;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentResume2Binding.inflate(inflater, container, false);
        setupUI();
