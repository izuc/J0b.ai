...
import ai.j0b.databinding.FragmentResume3Binding;
...
public class FragmentResume3 extends Fragment {
    private FragmentResume3Binding binding;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentResume3Binding.inflate(inflater, container, false);
        setupUI();
        return binding.getRoot();
    }

    private void setupUI() {
        loadData(Constant.INSTANCE.getProfileImageKey(), data -> Glide.with(requireActivity()).load((String)data).into(binding.ivProfile));
        ...
        loadListData(Constant.INSTANCE.getReferencesKey(), new TypeToken<ArrayList<ReferencesModel>>() {},list -> binding.recycleReferences.setAdapter(new ReferencesAdapter1(requireActivity(), list, "color1")));
